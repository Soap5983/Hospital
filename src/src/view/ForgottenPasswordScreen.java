...
public class ForgottenPasswordScreen extends JFrame {
    ...
    public int changePassword(String username, String newPassword){
        ...
        try {
            ...
            statement.executeUpdate("UPDATE doctors SET doctors.password = '" + newPassword + "' WHERE doctors.nameOfDoctor ='" + username + "';");
            /*
            while(resultSet.next()){
                if(resultSet.getString(2).equals(username)){
                    ...
                    //statement.executeUpdate("DELETE FROM doctors WHERE id = " + id +";");

                    //statement.executeUpdate("INSERT INTO `doctors` (`nameOfDoctor`, `UIN`, `password`, `specialty`) VALUES (" + "`"  + username +  "`,`" +  UIN + "`,`" +  newPassword + "`,`" + specialty + "`);");
                    statement.executeUpdate("UPDATE 'doctors' SET 'password' = " + newPassword + "WHERE 'username' =" + username);
                    return 0;
                }
            }
            /*
